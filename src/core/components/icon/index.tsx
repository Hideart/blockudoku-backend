...
export const EditIcon = ({color = AppColor.blue, width = 20, height = 20} = {}) => (
    <svg width={width} height={height} viewBox='0 0 20 20' fill='none' xmlns='http://www.w3.org/2000/svg'>
        <path d='M1 17H19' stroke={color} stroke-width='2'/>
        <path d='M5 10V13H8L15 6L12 3L5 10Z' stroke={color} stroke-width='2'/>
    </svg>
);
...
export const OptimizeIcon = ({color = AppColor.white, width = 18, height = 18} = {}) => (
    <svg width={width} height={height} viewBox='0 0 18 18' fill='none' xmlns='http://www.w3.org/2000/svg'>
        <circle cx='9' cy='9' r='8' stroke={color} stroke-width='2'/>
        <path d='M1 11H17' stroke={color} stroke-width='2'/>
        <path d='M9 11L13 7' stroke={color} stroke-width='2'/>
    </svg>
);
...
export const AutoassignIcon = ({color = AppColor.white, width = 20, height = 12} = {}) => (
    <svg width={width} height={height} viewBox='0 0 20 12' fill='none' xmlns='http://www.w3.org/2000/svg'>
        <path d='M1 7L4 10L13 1' stroke={color} stroke-width='2'/>
        <path d='M7 7L10 10L19 1' stroke={color} stroke-width='2'/>
    </svg>
);
...
export const UnscheduleIcon = ({color = AppColor.white, width = 18, height = 18} = {}) => (
    <svg width={width} height={height} viewBox='0 0 18 18' fill='none' xmlns='http://www.w3.org/2000/svg'>
        <circle cx='9' cy='9' r='8' stroke={color} stroke-width='2'/>
        <path d='M12 6L6 12' stroke={color} stroke-width='2'/>
        <path d='M6 6L12 12' stroke={color} stroke-width='2'/>
    </svg>
);
...
export const ChatIcon = ({color = AppColor.blue, width = 22, height = 21} = {}) => (
    <svg width={width} height={height} viewBox='0 0 22 21' fill='none' xmlns='http://www.w3.org/2000/svg'>
        <path d='M21 1H1V16H4V19L9 16H21V1Z' stroke={color} stroke-width='2'/>
        <path d='M5 6C5.8 6 13.3333 6 17 6' stroke={color} stroke-width='2'/>
        <path d='M5 10C5.8 10 13.3333 10 17 10' stroke={color} stroke-width='2'/>
    </svg>
);
